                    ...
                    <table class="table table-striped table-condensed table-vcenter table-bordered table-sm" id="releaseFormTbl">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td style="width:60%;font-size:12px;"><strong id="rel_emp"></strong></td>
                            </tr>
                            <tr>
                                ...
                                <td style="width:60%;font-size:12px;" class="rel_destination">
                                    <select name="rel_destination" style="width:100%;" id="rel_destination" class="form-control select-select2"></select>
...
<script>
    ...
    function enableRem() {
        const filedes = $('#filedes');
        const table = $('#actionFormTbl');
        const remarksRowId = 'remarksRow';
