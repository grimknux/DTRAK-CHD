    ...
    <div class="col-lg-12">
        <div class="block full">
            ...
            <div class="row">
                <div class="col-sm-4">
                    <div class="side-form">
                        <form class="form-horizontal" id="document_type_form">
                            <?= csrf_field() ?>
                            <div class="form-group doc_type">
                                <label class="col-sm-4 control-label input-sm label-require" for="doc_type">Document Type</label>
                                <div class="col-md-8">
                                    <input type="text" id="doc_type" name="doc_type" class="col-sm-7 form-control" placeholder="Document Type">
                ...
                <div class="col-sm-8">
                    <div class="table-responsive">
                        <table class="table table-striped table-condensed table-vcenter table-bordered table-sm" id="document_type_table">
                            <thead>
                                <tr>
                                    <th style="width: 10%;font-size: 10px;text-align:center;">#</th>
                                    <th style="width: 25%;font-size: 10px;text-align:center;">Document Type Code</th>
                                    <th style="width: 45%;font-size: 10px;text-align:center;">Document Type</th>
                                    <th style="width: 20%;font-size: 10px;text-align:center;">Action</th>
                                </tr>
                            </thead>
                        </table>
                    </div>
...
<script src="<?= base_url(); ?>public/js/pages/ref.DocType.Function.js"></script>
<script src="<?= base_url(); ?>public/js/pages/reference.DocType.Table.js"></script>

<script>

$(document).ready(function(){

    uiRefDocumentType.init(base_url,csrfToken);
    refDocType.init();
