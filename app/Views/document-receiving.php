...
<div class="block overflow-hidden">
    <div class="block-title clearfix">
        ...
        <div class="block-options pull-left">
            <a href="javascript:void(0)" class="btn btn-effect-ripple btn-primary" id="bulkReceive"><i class="fa fa-folder-open"></i> Bulk Receive</a>
        </div>
        ...
        <table class="table table-striped table-condensed table-vcenter table-bordered table-sm remove-margin" id="receive-table">
            <thead>
                <tr>
                    ...
                    <th style="width: 22%;font-size: 10px;text-align:center;">Subject</th>
                    <th style="width: 15%;font-size: 10px;text-align:center;">Remarks</th>
                    <th style="width: 7%;font-size: 10px;text-align:center;">Document Type</th>
                    <th style="width: 6%;font-size: 10px;text-align:center;">Date/Time Log</th>
                    <th style="width: 12%;font-size: 10px;text-align:center;">Action</th>
                </tr>
            </thead>
        </table>
    </div>
...
$(document).ready(function(){
    ...
    UiTables.init(base_url,csrfToken,'#custom-print-container');
