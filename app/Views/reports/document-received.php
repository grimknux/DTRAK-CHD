...
<div class="row">
    <div class="col-lg-12">
        <div class="block full">
            ...
            <div class="row">
                <div class="col-sm-5">
                    <form class="form-horizontal" onsubmit="return false;" id="receive_form_report">
            ...
            <br>
            <button class="btn btn-effect-ripple btn-secondary" onclick="printTable('#report-receive-table')"><i class="fa fa-print"></i> Print Report</button>
            <br>
            <div class="table-responsive">
                <table class="table table-striped table-condensed table-vcenter table-bordered table-sm" id="report-receive-table">
                    <thead>
                        <tr>
                            <th style="text-align:center;" colspan="12"><strong style="font-size: 2em;">Received Documents</strong> <br>  <div id="table_office"></div> <div style="font-size: 10px;" id="table_report_date"></div></th>
                        </tr>
                        <tr>
                            ...
                            <th style="width: 10%;font-size: 10px;text-align:center;">Originating Office.</th>
                            <th style="width: 10%;font-size: 10px;text-align:center;">Previous Office</th>
                            <th style="width: 32%;font-size: 10px;text-align:center;">Subject</th>
                            <th style="width: 15%;font-size: 10px;text-align:center;">Document Type</th>
