    ...
    <div class="col-lg-12">
        <div class="block full">
            <div class="block-title themed-background-dark text-light">
                <h2>Acted-upon Documents</h2>
            </div>
            <div class="row">
                <div class="col-sm-5">
                    <form class="form-horizontal" onsubmit="return false;" id="action_form_report">
            ...
            <br>
            <button class="btn btn-effect-ripple btn-secondary" onclick="printTable('#report-action-table')"><i class="fa fa-print"></i> Print Report</button>
            <br>
            <div class="table-responsive">
                <table class="table table-striped table-condensed table-vcenter table-bordered table-sm" id="report-action-table">
                    <thead>
                        <tr>
                            <th style="text-align:center;" colspan="12"><strong style="font-size: 2em;">Acted-upon Documents</strong> <br>  <div id="table_office"></div> <div style="font-size: 10px;" id="table_report_date"></div></th>
                        </tr>
                        <tr>
                            <th style="width: 3%;font-size: 10px;text-align:center;"></th>
                            <th style="width: 10%;font-size: 10px;text-align:center;">Document Control No.</th>
                            ...
                            <th style="width: 24%;font-size: 10px;text-align:center;">Subject</th>
                            <th style="width: 12%;font-size: 10px;text-align:center;">Document Type</th>
                            <th style="width: 9%;font-size: 10px;text-align:center;">Date/Time Received</th>
                            <th style="width: 7%;font-size: 10px;text-align:center;">Received By</th>
                            <th style="width: 9%;font-size: 10px;text-align:center;">Date/Time Action</th>
                            <th style="width: 7%;font-size: 10px;text-align:center;">Action By</th>
                            <th style="width: 7%;font-size: 10px;text-align:center;">Action Taken</th>
                        </tr>
                    </thead>
                </table>
            </div>
