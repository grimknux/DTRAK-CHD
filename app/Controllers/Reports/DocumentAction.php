...
class DocumentAction extends BaseController
{
    ...
    public function index()
    {
        ...
        return view('reports/document-action', $data);
    }
                    ...
                    try {
                        ...
                        foreach ($documentQuery['data'] as $row) {
                            ...
                            $table_data[] = [
                                ...
                                'date_time_rcv' => date('F d, Y', strtotime($row['date_rcv'])) . "<br>" . date('h:i:s A', strtotime($row['time_rcv'])),
                                'rcv_by' => $row['rec_lastname'] . ", " . $row['rec_firstname'] . " " . $row['rec_middlename'],
                                'date_time_act' => date('F d, Y', strtotime($row['date_action'])) . "<br>" . date('h:i:s A', strtotime($row['time_action'])),
