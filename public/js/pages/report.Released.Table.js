...
var UiTables = function() {
    ...
    return {
        init: function(base_url,csrf_token) {
            ...
            var releasedTable = $("#report-released-table").dataTable(
                {
                    serverSide: true,
                    processing: true,
                    language: {
                    ...
                    ajax: {
                        ...
                        url: base_url + '/report/table/released',
                        data: function(d) {
            ...
            this.bindEvents(releasedTable);
            
        },

        bindEvents: function(releasedTable) {
            $('#released_form_report').on('submit', this.filterReportTable.bind(this, releasedTable));
            $(document)
                .on('click', '#cancelSearch', this.cancelSearchBtn.bind(this,releasedTable));
        },
