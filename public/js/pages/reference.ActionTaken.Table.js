...
var uiRefActionTaken = function() {
    ...
    return {
        init: function(base_url,csrf_token) {
            ...
            var actionTakenTbl = $("#action_taken_table").dataTable(
                {
                    
                    ajax: {
                
                        url: base_url + '/admin/reference/action_taken/table',
                    ...
                    createdRow: function(row, data, dataIndex) {
                        ...
                        $(row).attr('action_code', data.action_code);
                        $(row).attr('action_desc', data.action_desc);
                    },
