...
var UiTables = function() {
    ...
    return {
        init: function(base_url,csrf_token) {
            ...
            var actionTable = $("#report-action-table").dataTable(
                {
                    serverSide: true,
                    processing: true,
                    language: {
                    ...
                    ajax: {
                        ...
                        url: base_url + '/report/table/action',
                        data: function(d) {
            ...
            this.bindEvents(actionTable);
            
        },

        bindEvents: function(actionTable) {
            $('#action_form_report').on('submit', this.filterReportTable.bind(this, actionTable));
            $(document)
                .on('click', '#cancelSearch', this.cancelSearchBtn.bind(this,actionTable));
        },
