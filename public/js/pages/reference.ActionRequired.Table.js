...
var uiRefActionRequired = function() {
    ...
    return {
        init: function(base_url,csrf_token) {
            ...
            var documenTypeTable = $("#action_required_table").dataTable(
                {
                    
                    ajax: {
                
                        url: base_url + '/admin/reference/action_required/table',
                    ...
                    createdRow: function(row, data, dataIndex) {
                        ...
                        $(row).attr('reqaction_code', data.reqaction_code);
                        $(row).attr('reqaction_desc', data.reqaction_desc);
                    },
